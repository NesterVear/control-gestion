...
import { Captura, createCaptura, updateCaptura, getCapturaByFolio } from '../../services/capturaService';
import { TextField, Button, MenuItem, Select,  } from '@mui/icons-material';
...
export const CapturaForm: React.FC = () => {
  ...
  const validateForm = () => {
    const requiredFields = ['fecha_elaboracion', 'fecha_recepcion', 'numero_oficio', 'prioridad', 'tipo'];
  ...
  return (
    ...
    onChange={(e) => handleInputChange('atendio', e.target.value)}
    />
    </Grid>
